...
/**
 * @brief    reset zigbee to factory setting.
 * 
 * @retval   0: success
 * @retval  !0: failure
 */ 
int tuya_user_iot_reset_zigbee(void);
 ...
 * @retval  !0: failure
 */
int tuya_user_iot_dev_update_version(const char *dev_id, const char *version);
 ...
 * @retval  !0: failure
 */
int tuya_user_iot_dev_fresh_heatbeat(const char *dev_id, uint32_t timeout);
